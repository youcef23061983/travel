...
export async function generateMetadata({ params: { locale } }) {
  ...
  const homePageMessages = messages["Policy"];
...
const page = () => {
  ...
  return (
    <div>
      <FrontImage
        image="/pageImages/policy.jpg"
        header1="imgHeader"
        header2="imgTitle"
        translateName="Policy"
      />
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{t("informationWeCollectP")}</p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{t("howWeUseYourInformationP")}</p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{t("sharingYourInformationP")}</p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{t("dataSecurityP")}</p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{t("yourRightsP")}</p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{t("retentionOfDataP")}</p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{t("changesToThisPrivacyPolicyP")}</p>
            </div>
          </div>
          <div className="space-y-4">
            <div>
